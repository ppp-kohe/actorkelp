...
public class KeyHistogramsPersistable extends KeyHistograms {
    ...
    public static class PersistentConditionHistogramSampling implements PersistentConditionHistogram {
        protected MailboxPersistableReplacement mailbox;
        ...
        public PersistentConditionHistogramSampling(long sizeLimit, double sizeRationThreshold, MailboxPersistableReplacement mailbox,
        ...
        public HistogramPersistentOperation needToPersist(String callerInfo, HistogramTreePersistable tree,
            ...
            if (onMemoryValues > sizeLimit) {
                ...
                if (log || res) {
                    mailboxSampling.getLogger().log(MailboxPersistableReplacement.logPersist, logPersistColor,
    ...
    public static class HistogramTreePersistable extends KeyHistograms.HistogramTree implements HistogramTreePersistableConfig {
        ...
        protected void logPersistedTreeBefore(long persistingLimit, Object obj) {
            PersistentFileManager m = getPersistent();
            if (m != null) {
                m.getLogger().log(MailboxPersistableReplacement.logPersist, logPersistColor,
        ...
        protected void logPersisted(String head, long prevPersist, Object obj1, Object obj2) {
            PersistentFileManager m = getPersistent();
            if (m != null && MailboxPersistableReplacement.logPersist) {
            ...
            try {
                if ((node instanceof HistogramNodeOnStorage) &&
                    ...
                    if (leaf) {
                        ...
                        if (MailboxPersistableReplacement.logDebugPersist) {
        ...
        public Object lookAhead(HistogramTree tree) {
            try {
                ...
                if (v instanceof HistogramLeafCellSerializedEnd) {
                    reader.getManager().getLogger().log(MailboxPersistableReplacement.logDebugPersist,
        ...
        protected void load() {
            if (!loaded) {
                ...
                try (PersistentFileManager.PersistentFileReader r = source.createReader()) {
                    ...
                    this.children = cs;
                    updateChildren();
                    r.getManager().getLogger().log(MailboxPersistableReplacement.logDebugPersist, logPersistColor, "close: %s", r);
                } catch (Exception ex) {
    ...
    public static class HistogramNodeLeafOnStorage extends HistogramNodeLeaf implements HistogramNodeOnStorage {
        ...
        protected void putValueStruct(HistogramPutContext context) {
            if (MailboxPersistableReplacement.logPersist) { //use regular logPersist
